...
const i18n = {
    ...
    es: {
        libEmpty: "La biblioteca est�� vac��a.", searchBooks: "Buscar libros...", loadingDocs: "Leyendo documento...", 
        booksCount: "Libros", continueReading: "Continuar leyendo", bookCollection: "Colecci��n de libros", 
        ...
        bookmarkEmpty: "A��n no hay marcadores.",
        
        bookmarkModalTitle: "Marcador",
        bookmarkTitlePlaceholder: "T��tulo del marcador...",
        bookmarkNotePlaceholder: "Escribe una nota (opcional)...",
        bookmarkCancel: "Cancelar",
        bookmarkSave: "Guardar",

        extractingCover: "Extrayendo portada...", readingPage: "Leyendo p��gina", formattingText: "Formateando texto...",
        extractingEpub: "Extrayendo EPUB...", analyzingStructure: "Analizando estructura...", extractingChapter: "Extrayendo cap��tulo",
        welcomeTitle: "Bienvenido a Baca.", welcomeDesc: "Por favor, lee estas instrucciones para una experiencia de lectura ��ptima.",
        welBackup: "Copia de seguridad", 
        welBackupDesc: "Hay 2 opciones de copia en Ajustes ��� Datos de la app:<br><br><b>JSON (Solo progreso)</b> ��� Ligero y r��pido. Guarda solo marcadores, progreso e notas. <u>Antes de restaurar, debes volver a subir los archivos del libro (PDF/Canvas) correspondientes al estante de tu ��ltima copia.</u><br><br><b>ZIP (Paquete completo)</b> ��� Superior porque guarda <i>todos los datos</i> incluyendo el contenido del libro. Listo para leer tras restaurar, sin necesidad de volver a subir.<br><br><b>C��mo hacer copia:</b> Pulsa Copia ��� elige formato ��� el archivo se guarda autom��ticamente en la carpeta <b>Documentos</b> de tu Android (almacenamiento interno, no Google Drive).",
        welFormat: "Limitaciones de formato",
        welFormatDesc: "<b>PDF Modo Desplazamiento:</b> Solo se extrae el texto. Las im��genes se ignoran. Compatible con selecci��n de texto, resaltados e IA.<br><b>PDF Modo Canvas:</b> Muestra el dise��o visual original como impresi��n f��sica. Las im��genes son visibles. Admite zoom. No admite cambio de fuente ni IA.<br><b>EPUB:</b> Totalmente compatible incluyendo im��genes.",
        welCanvas: "Modo Canvas PDF",
        welCanvasDesc: "El Modo Canvas muestra las p��ginas del PDF exactamente como son, incluyendo im��genes. Ideal para libros escaneados. Funciones: pellizcar para hacer zoom, deslizar p��ginas. <b>No admite</b> cambios de tama��o de fuente, alineaci��n de texto, IA ni selecci��n de texto.",
        welPrivacy: "Privacidad total", welPrivacyDesc: "Todo se procesa localmente en tu dispositivo. No se env��an datos a ning��n servidor.", welBtn: "Entendido",
        statExpand: "Ver gr��fico",
        statCollapse: "Cerrar gr��fico",
        statChartTitle: "Actividad de lectura (Minutos)",
        statChartDays: "��ltimos d��as",
        statChartEmpty: "A��n no hay datos de actividad de lectura.",
        statChartPages: "p��ginas",
        setMainTitle: "Ajustes", setPalette: "Paleta de temas", setLang: "Idioma", setInfo: "Informaci��n y soporte",
        btnInfo: "Ver instrucciones", btnDonate: "C��mprame un caf��", btnClose: "Cerrar",
        setData: "Datos de la app", btnBackup: "Copia de seguridad", btnRestore: "Restaurar datos",
        
        // Teks Sistem Cek Update
        btnUpdate: "Buscar actualizaciones",
        updateChecking: "Comprobando versi��n...",
        updateLatestTitle: "Actualizado",
        updateLatestDesc: `Est��s usando la ��ltima versi��n.`,
        updateAvailableTitle: "��Actualizaci��n disponible!",
        updateAvailableDesc: "Hay una nueva versi��n. ��Abrir la p��gina de descarga ahora?",
        updateError: "Error al comprobar actualizaciones. Revisa tu conexi��n a internet.",
        btnDownload: "Descargar",

        navBack: "Atr��s", navToc: "��ndice", navSearch: "Buscar", navJumpPage: "Ir a P��gina", navText: "Texto", navFull: "Completo",
        readerLoading: "Cargando libro...", tocTitle: "��ndice", setTitle: "Apariencia",
        setTheme: "Modo de tema", setSize: "Tama��o del texto", setAlign: "Alineaci��n", setFont: "Tipo de letra",
        searchPlaceholder: "Buscar en el libro...", searchNotFound: "No encontrado.",
        aiTitle: "Definici��n", aiLoading: "Buscando referencias...", noInternet: "Problema de conexi��n a internet.",
        deleteNoteConfirm: "��Eliminar esta nota/resaltado?",
        editTitle: "Editar detalles", editBookTitle: "T��tulo del libro", editBookCover: "Imagen de portada", editBookShape: "Forma de la tarjeta", editCancel: "Cancelar", editSave: "Guardar", optCancel: "Cancelar", themeLight: "Modo claro", themeDark: "Modo oscuro", amoledLabel: "AMOLED (Negro puro)",
        shapeDyn: "Din��mico", shapeRound: "Redondeado", shapeSquare: "Cuadrado",               
        rawBakTitle: "Datos de copia de seguridad sin procesar", rawBakDesc: "Debido a restricciones del dispositivo, copia el texto a continuaci��n y gu��rdalo de forma segura en tus Notas.", rawBakCopy: "Copiar texto", rawBakClose: "Cerrar",
        ...
        setAiConfig: "Configuraci��n de IA", geminiPlaceholder: "Clave API de Gemini...", geminiDesc: "A��ade tu clave API para obtener definiciones inteligentes de la IA. (Configuraci��n ��ptima: usa Gemini 2.5 Flash Lite para m��xima velocidad).", keySaved: "Clave API guardada con ��xito.",

        statTitle: "Estad��sticas", statTotal: "Colecci��n", statReading: "Leyendo", statCompleted: "Completados", statNotes: "Notas",

        // Fitur Hapus Sampul
        btnClearCovers: "Borrar Todas las Portadas (Ahorrar Memoria)",
        clearCoversTitle: "��Borrar Todas las Portadas?",
        clearCoversDesc: "Todas las portadas se eliminan permanentemente para ahorrar memoria. El texto y progreso est��n 100% seguros. ��Continuar?",
        clearCoversSuccess: "��Portadas borradas! La aplicaci��n ahora es m��s ligera.",

        // Fitur Hapus Semua Buku
        btnClearAllBooks: "Borrar Todos los Libros (Reinicio Total)",
        clearAllBooksTitle: "��Borrar Todos los Libros?",
        clearAllBooksDesc: "Todos los libros, progreso, notas, portadas y contenido se eliminar��n permanentemente. Esta acci��n no se puede deshacer. ��Continuar?",
        clearAllBooksSuccessTitle: "Todos los Libros Borrados",
        clearAllBooksSuccess: "Todos los libros han sido eliminados. Tu biblioteca est�� vac��a.",

        // Opsi Backup Baru & Status Fallback
        bakModalTitle: "Tipo de copia", bakModalDesc: "Elige el formato de copia de seguridad:",
        bakJsonTitle: "JSON (Solo progreso)", bakJsonDesc: "Muy ligero. Guarda solo la lista, progreso y notas. Debes volver a subir los libros originales despu��s.",
        ...
        zipRestoreConfirm: "Se encontraron {n} libros completos en este ZIP. Se restaurar��n en tu biblioteca. ��Continuar?",

        // --- NEW TRANSLATIONS FOR PHASE 1: DUAL-MODE PDF ---
        scrollRakTitle: "Libros Modo Desplazamiento",
        canvasRakTitle: "Canvas Mode Books",
        pdfModePromptTitle: "Elegir Modo de Lectura",
        pdfModePromptDesc: "Este PDF contiene texto din��mico extra��ble. Elija su estilo de lectura preferido:",
        pdfModeBtnScroll: "Modo Desplazamiento (Recomendado)",
        pdfModeBtnScrollDesc: "Texto fluido, fuentes ajustables, admite selecci��n de texto, resaltados y Gemini AI.",
        pdfModeBtnCanvas: "Modo Canvas (Dise��o Original)",
        pdfModeBtnCanvasDesc: "Muestra el dise��o visual original de las p��ginas. Admite zoom, pero las fuentes y la IA est��n deshabilitadas.",
        pdfCanvasWarning: "Las opciones de tipograf��a, definiciones de IA y selecci��n de texto est��n deshabilitadas en el Modo Canvas.",
        pdfCanvasImageOnlyWarning: "Este PDF solo contiene im��genes (escaneado), la b��squeda de palabras no est�� disponible porque no se pudo extraer texto.",
        pdfPageLabel: "P��g",
        pdfTotalPages: "Total de P��ginas",
        pdfCanvasBadge: "PDF-CANVAS",
        pdfScrollBadge: "PDF-SCROLL",
        txtPageGo: "Ir a la P��gina:",
        btnGoPage: "Saltar",
        canvasNoText: "Este PDF se detecta como un documento de imagen escaneada. Importado autom��ticamente al Modo Canvas para preservar su dise��o visual original.",

        // --- PHASE 3 UI UPDATES & NEW MODALS ---
        tocCanvasWarning: "El ��ndice no est�� disponible en el modo canvas.",
        expressiveLabel: "Expresivo",
        uploadDuplicateTitle: "El Libro Ya Existe",
        uploadDuplicateDesc: "El siguiente libro ya est�� en tu estante. ��A��adir de todos modos (nuevo archivo) o saltar?",
        btnSkip: "Saltar",
        btnAddAnyway: "A��adir de Todos Modos",
        batchPdfTitle: "Seleccionar Modo PDF",
        batchPdfDesc: "Elige el modo de lectura para los PDFs reci��n subidos:",
        btnStartProcess: "Iniciar Proceso",
        bookmarkSearchPlaceholder: "Buscar marcadores...",
        importDoneTitle: "Importaci��n Completa",
        importSuccessCount: "{n} libros importados con ��xito.",
        importFailedCount: "{n} fallidos:",
        folderNoFiles: "No se encontraron archivos PDF, EPUB, TXT o MD en esta carpeta.",
        pdfBothModesTitle: "El Libro Ya Est�� en el Estante",
        pdfBothModesDesc: "El siguiente libro ya est�� en ambos estantes (Scroll & Canvas). No se puede a��adir de nuevo.",
        pdfScrollWillDelete: "Canvas (versi��n Scroll se eliminar��)",
        pdfCanvasWillDelete: "Scroll (versi��n Canvas se eliminar��)",
        batchDismiss: "Quitar de la lista",

        // --- ARCHIVE.ORG SEARCH ---
        archiveSearchTitle: "Encontrar Libros en Internet Archive",
        archiveSearchPlaceholder: "Buscar t��tulo, autor, tema...",
        ...
        archiveSearchError: "Error al buscar. Comprueba tu conexi��n a internet.",
        ...
        archiveFic: "Ficci��n Popular",
        archiveSci: "Ciencia y Conocimiento",
        archiveHis: "Historia Mundial",
        archiveTech: "Tecnolog��a",
        archivePhil: "Filosof��a",
        archiveFantasy: "Fantas��a y Magia",
        archiveLoading: "Cargando recomendaciones...",
        archiveFailed: "Error al cargar recomendaciones.",

        // --- ARCHIVE DOWNLOAD RESULT TOASTS ---
        toastBookAdded: "��Libro a��adido con ��xito!",
        toastBookDuplicate: "El libro \"{title}\" ya est�� en tu estante.",
        toastBookFailed: "Error al procesar, el archivo puede estar da��ado.",
